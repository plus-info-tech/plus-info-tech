...
register_sidebar(array(
     'name' => '投稿内ウィジェット）' , //判別しやすい名前。
     'id' => 'post_top_area' , //ウィジェットエリアのID。
     'description' => 'これは追加したウィジェットエリアです。', //ウィジェットエリアの説明。
     'before_widget' => '<div class="post-top-area">', //ウィジェットエリアの開始HTMLタグ。
     'after_widget' => '</div>', //ウィジェットエリアの終了HTMLタグ。
     'before_title' => '<h3>', //ウィジェットタイトルの開始HTMLタグ。
     'after_title' => '</h3>' //ウィジェットタイトルの終了HTMLタグ。
));
}
